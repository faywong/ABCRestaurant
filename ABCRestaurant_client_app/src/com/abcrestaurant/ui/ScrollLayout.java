/*
 *  @file: ScrollLayout.java
 *  @author: wangfei<wang.fei@pset.suntec.net>
 *  @date: 2011-10-27
 */
...
/**
 * just like the Workspace(enable the user to switch between app pages by
 * scrolling)
 * 
 */
public class ScrollLayout extends ViewGroup {
	...
	public void setCurrentScreenIndex(int CurScreen) {
		this.mCurScreen = CurScreen;
	}
	...
	public void snapToScreen(int whichScreen) {
		if (DEBUG) {
			Log.e(TAG, "in snapToScreen() , whichScreen:" + whichScreen);
		}
		...
		if (getScrollX() != (whichScreen * getWidth())) {
			...
			if (DEBUG)
				Log.e(TAG, "in snapToScreen() , setting mCurScreen to:"
						+ whichScreen);
	...
	public int getCurScreen() {
		if (DEBUG)
			Log.e(TAG, "in getCurScreen() , return mCurScreen:" + mCurScreen);
		return mCurScreen;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			if (velocityX > SNAP_VELOCITY && mCurScreen > 0) {
				...
				if (DEBUG)
					Log.e(TAG, "snap right, onScreenChangeListener:"
	...
	public void scrollLeft() {
		if (DEBUG)
			Log.e(TAG, "snap Left mCurScreen=" + mCurScreen
					+ " getChildCount():" + getChildCount());
		if (mCurScreen - 1 < 0) {
			if (DEBUG)
				Log.e(TAG, "scrollLeft, direct return");
			return;
		}
		onScreenChangeListener.onScreenChange(mCurScreen - 1);
		snapToScreen(mCurScreen - 1);
	...
	public void scrollRight() {
		if (DEBUG)
			Log.e(TAG, "snap Right mCurScreen=" + mCurScreen
					+ " getChildCount():" + getChildCount());
		if (mCurScreen + 1 > getChildCount()) {
			if (DEBUG)
				Log.e(TAG, "scrollRight, direct return");
			return;
		}
		onScreenChangeListener.onScreenChange(mCurScreen + 1);
		// onScreenChangeListenerDataLoad.onScreenChange(mCurScreen+1);
